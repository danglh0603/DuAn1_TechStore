package com.DuAn1.techstore.DAO;
...
public class Server {
    ...
    public static String updateSanPham = localhost + "/api/UpdateSanPham.php";
    ...
    // hoa don
    public static String insertHoaDon = localhost + "/api/InsertHoaDon.php";
    public static String insertChiTietHoaDon = localhost + "/api/InsertChiTietHoaDon.php";
    ...
    // gio hang
    public static String insertGioHang = localhost + "/api/InsertGioHang.php";
